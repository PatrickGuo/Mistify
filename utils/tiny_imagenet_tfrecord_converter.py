...
Note: this file refers to
https://github.com/tensorflow/models/blob/master/research/adversarial_logit_pairing/tiny_imagenet_converter/converter.py
"""
            ...
            for image_filename, image_metadata in annotations:
                ...
                features = {
                    ...
                    'image/format': tf.train.Feature(
                        bytes_list=tf.train.BytesList(value=[image_format.encode(encoding='utf-8')]))
                }
                if image_metadata:
                    ...
                    features['label/wnid'] = tf.train.Feature(
                        bytes_list=tf.train.BytesList(value=[image_metadata.label.encode(encoding='utf-8')]))
