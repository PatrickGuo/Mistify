...
class _ExtendedDecorator(_Decorator):
...
class _SocketExtendedDecorator(_ExtendedDecorator):
    def process_decorator_args(self, *args, **kwargs):
        """Also grab context_name out of kwargs"""
        kw_name, args, kwargs = super(_SocketExtendedDecorator, self).process_decorator_args(*args, **kwargs)
...
def multi_sockets(*args, **kwargs):
    return _SocketExtendedDecorator()(*args, **kwargs)
