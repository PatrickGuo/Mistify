...
from trimming.morphnet.framework import logistic_sigmoid_source_op_handler as ls_handler
...
from trimming.morphnet.framework import probabilistic_grouping_regularizer as pgr
