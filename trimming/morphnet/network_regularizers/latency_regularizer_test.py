...
from trimming.morphnet.network_regularizers import flop_regularizer
from trimming.morphnet.network_regularizers import latency_regularizer
from trimming.morphnet.network_regularizers import model_size_regularizer
