...
from trimming.morphnet.network_regularizers import flop_regularizer as fr
from trimming.morphnet.network_regularizers import model_size_regularizer as msr
